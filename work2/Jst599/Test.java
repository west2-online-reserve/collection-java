...
public class Test {
    public static void main(String[] args) {
        ...
        Customer Jackson = new Customer("Jackson", 4, LocalDate.now());
        Customer Rose = new Customer("Rose", 5, LocalDate.now());
        Customer James = new Customer("James", 4, LocalDate.now());
        Customer Harden = new Customer("Harden", 5, LocalDate.now());
        Customer Curry = new Customer("Curry", 3, LocalDate.now());
