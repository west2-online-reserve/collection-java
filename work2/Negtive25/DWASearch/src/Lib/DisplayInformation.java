...
import static com.src.Lib.CreateAthleteList.createPlayerlist;
...
public class DisplayInformation {
    ...
    public static void displayAllAthletes(String outputFile) throws IOException {
        ...
        String allAthlete = FileReadAndWrite.readFile("src/main/java/com/src/Data/athleteInformation/allAthlete.txt");
