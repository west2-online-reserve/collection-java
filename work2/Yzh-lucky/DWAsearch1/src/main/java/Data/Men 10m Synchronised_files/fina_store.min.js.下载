...
(function (app) {
  ...
  const watch = function watch(getState, objectPath) {
   ...
   */
  app.redux.watch = function (dataPath, callback) {
    let fireImmediately = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    if (fireImmediately) {
   ...
   */
  app.redux.getInitialStateFromURL = function () {
    let allowList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
