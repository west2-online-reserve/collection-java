...
public class MyAnimalShop implements AnimalShop{
    ...
    public void decreaseBalance(double decrement) throws IllegalArgumentException, InsufficientBalanceException {
        if (decrement < 0) {
    ...
    public void receiveCustomer(Customer customer, Animal animal) throws AnimalNotFoundException{
        ...
        if(this.animals.contains(animal)) {
            ...
            this.setProfit(this.getProfit() + animal.getPrice()+20);
