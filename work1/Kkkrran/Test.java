public class Test {
    ...
    public static void main(String[] args) {
        //购买西瓜方法测试
        Booth booth1 = new Booth(22222222, "张三", 300, false);
        ...
        //进货测试
        Booth booth2 = new Booth(11111111,"李四", 500, false);
        booth2.restock(500); // 进货失败,数量超过上限
        booth2.restock(-100); //进货数量不能小于0，进货失败
        booth2.restock(100); // 进货成功
        ...
        System.out.println(booth2.isClosed()); //true
