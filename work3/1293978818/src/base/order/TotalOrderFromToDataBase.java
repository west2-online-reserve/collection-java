...
public class TotalOrderFromToDataBase {
     ...
     * @return 是否删除成功
     */
    public boolean deleteTotalOrder(int orderId){
     ...
     * @return 是否存入成功
     */
    public boolean updateTotalOrder(TotalOrder totalOrder){
     ...
     */
    public TotalOrder getTotalOrder(int orderId){
