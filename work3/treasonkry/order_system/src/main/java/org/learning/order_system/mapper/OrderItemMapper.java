...
public interface OrderItemMapper {
    @Select("select order_id, product_id, quantity, item_price, subtotal from order_item")
    ...
    @Select("select order_id, product_id, quantity, item_price, subtotal from order_item where item_id=#{itemId}")
